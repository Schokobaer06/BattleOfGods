...
public class Item extends net.minecraft.world.item.Item implements FeatureElement, ItemLike, net.minecraftforge.common.extensions.IForgeItem {
    ...
    private final Holder.Reference<net.minecraft.world.item.Item> builtInRegistryHolder = BuiltInRegistries.ITEM.createIntrusiveHolder(this);
    ...
    public static net.minecraft.world.item.Item byId(int p_41446_) {
     ...
     */
    @Deprecated
    public static net.minecraft.world.item.Item byBlock(Block p_41440_) {
