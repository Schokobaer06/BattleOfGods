...
public class InitSubClass {
    public static final ResourceKey<Registry<Item>> ITEM_KEY =
            ResourceKey.createRegistryKey(new ResourceLocation(BattleofgodsMod.MODID, "items"));
    public static final DeferredRegister<Item> SUBCLASSES= DeferredRegister.create(ITEM_KEY, BattleofgodsMod.MODID);
