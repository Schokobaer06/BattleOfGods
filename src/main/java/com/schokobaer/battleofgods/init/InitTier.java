...
public class InitTier {
    ...
    public static final ResourceKey<Registry<Tier>> TIER_KEY =
            ResourceKey.createRegistryKey(new ResourceLocation(BattleOfGods.MODID, "tiers"));
    public static final DeferredRegister<Tier> TIERS = DeferredRegister.create(TIER_KEY, BattleOfGods.MODID);
