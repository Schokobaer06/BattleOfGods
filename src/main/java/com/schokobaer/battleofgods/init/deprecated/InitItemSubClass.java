package com.schokobaer.battleofgods.init.deprecated;
/*
@Deprecated
public class InitItemSubClass {
    ...
    public static final RegistryObject<ItemSubClass> BROADSWORD = registerBroadSwordSubClass(new Item.Properties(), "broadsword", InitItemClass.ROGUE);
