...
public class InitItemSubClass {
    ...
    private static RegistryObject<ItemSubClass> registerItemSubClass(Item.Properties properties, String name, ItemClass itemClass) {
        TagKey<Item> tag = ItemSubClassTags.create(name,itemClass);
        return ITEM_SUBCLASSES.register(name, () -> new Broadsword(properties, name, tag));
    }
}